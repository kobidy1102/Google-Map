...
public class Adapter_Lv_ChatRieng_ChiTietTin extends ArrayAdapter<ThongTinTinNhan_ChatRieng> {
    public Adapter_Lv_ChatRieng_ChiTietTin(Context context, int resourse, List<ThongTinTinNhan_ChatRieng> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            // Get item
            final ThongTinTinNhan_ChatRieng tttn = getItem(position);
            if (tttn != null) {
